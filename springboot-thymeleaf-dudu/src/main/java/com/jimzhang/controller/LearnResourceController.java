...
import com.jimzhang.domain.LearnResouce;
...
public class LearnResourceController {
    ...
    public ModelAndView index2() {
        ...
        bean = new LearnResouce("官方SpriongBoot例子", "官方SpriongBoot例子", "https://github.com/spring-projects/spring-boot/tree/master/spring-boot-samples");
        learnList.add(bean);
        bean = new LearnResouce("龙果学院", "Spring Boot 教程系列学习", "http://www.roncoo.com/article/detail/125488");
        learnList.add(bean);
        bean = new LearnResouce("嘟嘟MD独立博客", "Spring Boot干货系列 ", "http://tengj.top/");
        learnList.add(bean);
        bean = new LearnResouce("后端编程嘟", "Spring Boot教程和视频 ", "http://www.toutiao.com/m1559096720023553/");
        ...
        bean = new LearnResouce("纯洁的微笑", "Sping Boot系列文章", "http://www.ityouknow.com/spring-boot");
        learnList.add(bean);
        bean = new LearnResouce("CSDN-小单博客Spring Boot专栏", "Sping Boot学习", "http://blog.csdn.net/column/details/spring-boot.html");
        learnList.add(bean);
        bean = new LearnResouce("梁桂钊的博客", "Spring Boot 揭秘与实战", "http://blog.csdn.net/column/details/spring-boot.html");
        learnList.add(bean);
        bean = new LearnResouce("林祥纤博客系列", "从零开始学Spring Boot ", "http://412887952-qq-com.iteye.com/category/356333");
        learnList.add(bean);
        bean = new LearnResouce("泥瓦匠BYSocket的Spring Boot系列", "Spring Boot 那些事", "http://www.bysocket.com/?page_id=1639");
        learnList.add(bean);
        bean = new LearnResouce("杜琪关于Spring Boot的博客集合", "关于Spring Boot的博客集合", "http://www.jianshu.com/p/7e2e5e7b32ab");
        learnList.add(bean);
        bean = new LearnResouce("SpringBoot参考指南中文版", "SpringBoot参考指南中文版", "https://gitlore.com/subject/23?filePath=IV.%20spring_boot_features.md");
        learnList.add(bean);
